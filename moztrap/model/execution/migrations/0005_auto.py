...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tags on 'Run'
        db.create_table('execution_run_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('run', models.ForeignKey(orm['execution.run'], null=False)),
            ('tag', models.ForeignKey(orm['tags.tag'], null=False))
        ))
        db.create_unique('execution_run_tags', ['run_id', 'tag_id'])

    def backwards(self, orm):
        # Removing M2M table for field tags on 'Run'
        db.delete_table('execution_run_tags')
    ...
    models = {
        ...
        'core.product': {
            ...
            'created_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 13, 0, 0)'}),
            ...
            'modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 13, 0, 0)'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
        ...
        'execution.run': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'runs'", 'blank': 'True', 'to': "orm['tags.Tag']"})
        },
